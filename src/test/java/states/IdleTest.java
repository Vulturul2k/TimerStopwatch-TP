...
class IdleTest {
	...
	// The following "regression test" was added after having found a bug in the
	// code
	@Test
	@DisplayName("Singleton design pattern for IdleTimer")
	...
	@Test
	@DisplayName("Up event with no transition (memTimer is 0)")
	...
	@Test
	@DisplayName("Up event with transition to SetTimer and back")
