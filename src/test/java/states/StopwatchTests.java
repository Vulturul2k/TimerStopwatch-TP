...
class StopwatchTests {
	...
	void setup() {
		...
		context.currentState = AbstractStopwatch.getInstance();
	}
	...
	void testInitialState() {
		...
		assertSame(ResetStopwatch.getInstance(), current);
